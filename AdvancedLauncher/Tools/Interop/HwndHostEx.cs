...
using AdvancedLauncher.Tools.Extensions;
...
namespace AdvancedLauncher.Tools.Interop {
    ...
    public class HwndHostEx : HwndHost, IKeyboardInputSink {
        ...
        public bool RaiseMouseActivateCommand {
            get {
                return (bool)GetValue(RaiseMouseActivateCommandProperty);
            }
            set {
                SetValue(RaiseMouseActivateCommandProperty, value);
            }
        }
        ...
        public bool AsyncUpdateWindowPos {
            get {
                return (bool)GetValue(AsyncUpdateWindowPosProperty);
            }
            set {
                SetValue(AsyncUpdateWindowPosProperty, value);
            }
        }
